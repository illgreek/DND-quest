          ...
          {pendingRequests.length > 0 && (
            <div className="relative mb-6 rounded-lg overflow-hidden max-w-4xl mx-auto">
              ...
              <div className="bg-theme-surface p-6 rounded-lg relative z-10">
                <h3 className="text-lg font-bold text-theme-accent mb-4 flex items-center">
                ...
                <div className="space-y-3">
                  {pendingRequests.map((request) => {
                    ...
                    return sender ? (
                      <div key={request.id} className="flex items-center justify-between bg-theme-background rounded-lg p-4 border border-theme-border">
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-3 font-medium transition-colors rounded-md ${
                    activeTab === 'search'
                      ...
                      : 'text-gray-400 hover:text-gray-300 hover:bg-theme-background'
                  }`}
                >
                  Пошук героїв
                </button>
                        ...
                        <div className="bg-theme-surface p-6 rounded-xl relative z-10">
                          ...
                          {!friendshipStatus && (
                            <button
                              ...
                              className="relative font-medium tracking-wide rounded-lg flex items-center justify-center text-sm py-2.5 px-4 w-full bg-gradient-theme text-gray-100 hover:bg-gradient-theme-hover border border-theme-primary shadow-lg transition-all duration-200 transform hover:scale-105"
                            >
