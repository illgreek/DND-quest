            ...
            {session ? (
              <div className="space-y-4">
                <div className="relative mb-4 rounded-lg overflow-hidden max-w-4xl mx-auto">
                  ...
                  <div className="absolute inset-0 bg-gradient-theme p-[1px] rounded-lg overflow-hidden">
                    ...
                    <div className="absolute top-0 right-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-bl-lg border-b border-l border-theme-primary">
                      <SparklesIcon size={14} className="text-theme-accent" />
                    </div>
                    {/* Top-left corner decoration */}
                    <div className="absolute top-0 left-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-br-lg border-b border-r border-theme-primary">
                      <div className="w-2 h-2 bg-theme-accent rounded-full opacity-60"></div>
                    </div>
                    {/* Bottom-right corner decoration */}
                    <div className="absolute bottom-0 right-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-tl-lg border-t border-l border-theme-primary">
                      <div className="w-2 h-2 bg-theme-accent rounded-full opacity-60"></div>
                    </div>
                    {/* Bottom-left corner decoration */}
                    <div className="absolute bottom-0 left-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-tr-lg border-t border-r border-theme-primary">
                      <div className="w-2 h-2 bg-theme-accent rounded-full opacity-60"></div>
                    </div>
                    ...
                    <div className="absolute top-1/4 left-2 w-1 h-1 bg-theme-text rounded-full animate-pulse animation-delay-150"></div>
                    <div className="absolute top-1/4 right-2 w-1 h-1 bg-theme-text rounded-full animate-pulse animation-delay-450"></div>
                    <div className="absolute bottom-1/4 left-2 w-1 h-1 bg-theme-text rounded-full animate-pulse animation-delay-250"></div>
                    <div className="absolute bottom-1/4 right-2 w-1 h-1 bg-theme-text rounded-full animate-pulse animation-delay-550"></div>
                    
                    {/* Diagonal sparkles */}
                    <div className="absolute top-1/3 left-1/3 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-100"></div>
                    <div className="absolute top-2/3 right-1/3 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-400"></div>
                    <div className="absolute bottom-1/3 left-2/3 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-300"></div>
                    <div className="absolute top-2/3 left-1/3 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-600"></div>
                    
                    {/* Floating sparkles */}
                    <div className="absolute top-3 left-1/4 w-1 h-1 bg-theme-text rounded-full animate-pulse animation-delay-200"></div>
                    <div className="absolute top-3 right-1/4 w-1 h-1 bg-theme-text rounded-full animate-pulse animation-delay-500"></div>
                    <div className="absolute bottom-3 left-1/4 w-1 h-1 bg-theme-text rounded-full animate-pulse animation-delay-350"></div>
                    <div className="absolute bottom-3 right-1/4 w-1 h-1 bg-theme-text rounded-full animate-pulse animation-delay-650"></div>
                    
                    {/* Corner sparkles */}
                    <div className="absolute top-4 left-4 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-100"></div>
                    <div className="absolute top-4 right-4 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-400"></div>
                    <div className="absolute bottom-4 left-4 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-200"></div>
                    <div className="absolute bottom-4 right-4 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-500"></div>
                  </div>
                  {/* Card content */}
                  <div className="bg-theme-surface p-6 rounded-lg relative z-10">
                    {/* Inner decorative sparkles */}
                    <div className="absolute top-2 left-2 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-100"></div>
                    <div className="absolute top-2 right-2 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-300"></div>
                    <div className="absolute bottom-2 left-2 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-200"></div>
                    ...
                    <p className="text-gray-300 mb-4 text-center text-lg">
                      Рівень: <span className="text-theme-accent font-bold">{session.user.heroLevel}</span> | 
                      Клас: <span className="text-theme-accent font-bold">{getHeroClassLabel(session.user.heroClass || '') || 'Новичок'}</span>
                    </p>
                    
                    {/* Decorative divider */}
                    <div className="relative h-[1px] my-4">
                      <div className="absolute inset-0 bg-gradient-theme"></div>
                      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-theme-surface rounded-full flex items-center justify-center">
                        <SparklesIcon size={10} className="text-theme-accent" />
                      </div>
                    </div>
                    <div className="grid grid-cols-3 gap-3">
                      <Link 
                        href="/quests/my"
                        className="relative font-medium tracking-wide rounded-md flex items-center justify-center text-sm py-3 px-4 btn-theme shadow-lg transition-all duration-200 transform hover:scale-105"
                      >
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link 
                    href="/auth/signin"
                    className="relative font-medium tracking-wide rounded-md flex items-center justify-center py-4 px-8 btn-theme shadow-lg transition-all duration-200 transform hover:scale-105"
                  >
                    <span className="absolute left-2 top-1/2 -translate-y-1/2 w-1 h-1/2 bg-theme-accent opacity-50 rounded-full"></span>
                    <span className="absolute right-2 top-1/2 -translate-y-1/2 w-1 h-1/2 bg-theme-accent opacity-50 rounded-full"></span>
                    Увійти ⚔️
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="relative mb-4 rounded-lg overflow-hidden cursor-pointer transform transition-all hover:scale-[1.02] active:scale-[0.98]">
              ...
              <div className="absolute inset-0 bg-gradient-theme p-[1px] rounded-lg overflow-hidden">
                {/* Top-right corner decoration */}
                <div className="absolute top-0 right-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-bl-lg border-b border-l border-theme-primary">
                  <SwordIcon size={14} className="text-theme-accent" />
                </div>
                {/* Top-left corner decoration */}
                <div className="absolute top-0 left-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-br-lg border-b border-r border-theme-primary">
                  <div className="w-2 h-2 bg-theme-accent rounded-full opacity-60"></div>
              ...
              {/* Card content */}
              <div className="bg-theme-surface p-8 rounded-lg relative z-10 text-center">
                {/* Inner decorative sparkles */}
                <div className="absolute top-2 left-2 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-100"></div>
                <div className="absolute top-2 right-2 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-300"></div>
                <div className="absolute bottom-2 left-2 w-1 h-1 bg-theme-accent rounded-full animate-pulse animation-delay-200"></div>
            ...
            <div className="relative mb-4 rounded-lg overflow-hidden cursor-pointer transform transition-all hover:scale-[1.02] active:scale-[0.98]">
              ...
              <div className="absolute inset-0 bg-gradient-theme p-[1px] rounded-lg overflow-hidden">
                {/* Top-right corner decoration */}
                <div className="absolute top-0 right-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-bl-lg border-b border-l border-theme-primary">
                  <UsersIcon size={14} className="text-theme-accent" />
                </div>
                {/* Top-left corner decoration */}
                <div className="absolute top-0 left-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-br-lg border-b border-r border-theme-primary">
                  <div className="w-2 h-2 bg-theme-accent rounded-full opacity-60"></div>
            ...
            <div className="relative mb-4 rounded-lg overflow-hidden cursor-pointer transform transition-all hover:scale-[1.02] active:scale-[0.98]">
              ...
              <div className="absolute inset-0 bg-gradient-theme p-[1px] rounded-lg overflow-hidden">
                {/* Top-right corner decoration */}
                <div className="absolute top-0 right-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-bl-lg border-b border-l border-theme-primary">
                  <TrophyIcon size={14} className="text-theme-accent" />
                </div>
                {/* Top-left corner decoration */}
                <div className="absolute top-0 left-0 w-8 h-8 bg-theme-accent flex items-center justify-center rounded-br-lg border-b border-r border-theme-primary">
                  <div className="w-2 h-2 bg-theme-accent rounded-full opacity-60"></div>
